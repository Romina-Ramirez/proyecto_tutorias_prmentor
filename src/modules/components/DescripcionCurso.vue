  ...
  methods: {
    ...
    registrarMateria() {
      ...
      this.$router.push("/cursoMatematica");
        ...
        alert("¡Hola, no tienes acceso a mas materias. Puedes comprar mas paquetes en tu perfil para acceder a mas materias! ;) ");
      }
    },
    actualizarDatos() {
    ...
    actualizar() {
      ...
      console.log(retorno);
        ...
        this.linkReunion= `/${this.objetoCompartido.usuario.correo}`;
         alert("¡No te quedan horas disponibles!, En tu perfil puedes contratar un nuevo paquete para mas horas ;) ");
      }
    },
  },
  mounted() {
    if (
      ...
      console.log('Entro al true ',  Object.values(this.objetoCompartido.usuario.materias));
      this.inscrito = true;
    } else {
      console.log('Entro al false ',  Object.values(this.objetoCompartido.usuario.materias));
      this.inscrito = false;
    }
  },
};
